  ...
  return (
    <section className="w-full py-6">
      {settingsItem.map((setting, index) => (
        <div
          key={index}
          className="w-full p-4 mb-2 text-sm rounded-lg bg-[#4b1c2f44] hover:bg-transparent hover:border-[#4b1c2f] border flex items-center justify-between cursor-pointer "
