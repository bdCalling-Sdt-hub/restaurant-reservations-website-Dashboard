...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <div className="w-full px-5 py-3.5 bg-[#4b1c2f] flex justify-between items-center text-white sticky top-0 left-0 z-10">
      ...
      <div className="flex justify-between items-center gap-5">
        <Link to={"/notification"}>
          <h1 className="relative text-[#4b1c2f] p-2 rounded-full bg-white">
