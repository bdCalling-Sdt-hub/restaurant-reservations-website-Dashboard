    ...
    return (
        <div>
            <div className='md:p-4 mt-5 sm:mt-0 flex items-center justify-between'>
                ...
                <div>
                    <button
                        className="bg-[#4b1c2f] text-white px-10 py-3 text-xl rounded-lg flex items-center gap-2"
            ...
            >
                ...
                >
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <Button type="primary" htmlType="submit" className="bg-[#4b1c2f] text-white ">
                            Add FAQ
                        </Button>
                    </div>
                </Form>
